...
lazy val `combine-features-metadata` = (project in file("."))
  .enablePlugins(GitVersioning, GitBranchPrompt, JavaAppPackaging)
  .settings(ammoniteSettings)
//    .settings(spark("3.4.1"))
  .settings(spark_dev("3.4.1"))
  .settings(
    name := "combine-features-metadata",
    description := "Combines 'features' with 'metadata' sequence files to generate an EF file",
